...
//       String uid, String title, String notes, time, date) async {
//     String res = "Some error occurred";
//     try {
...
//         Event events =
//             Event(uid: uid, title: title, notes: notes, time: time, date: date);

//         _firestore.collection('Events').doc(EventId).set(events.toJson());
